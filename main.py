...
def main() -> None:
    application = ApplicationBuilder().token("7242950496:AAHlNr4SGLVrawrDBUYTh19gLZaZnc-cp-M").build()
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            CONFIRM_SUBSCRIPTION: [CallbackQueryHandler(confirm_subscription, pattern='^confirm_yes|confirm_now$')]
        },
